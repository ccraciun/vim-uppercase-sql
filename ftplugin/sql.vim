function! s:UppercaseKeyword(sql)
    ...
    " TODO: completion on <newline> is broken?
    if synIDattr(synIDtrans(synID(line("."), col(".") - 1, 0)), "name") =~# 'Comment\|String\|mysqlEscaped'
        return a:sql
    else
...
iabbrev <expr> <buffer> auto_increment <SID>UppercaseKeyword('auto_increment')
...
iabbrev <expr> <buffer> delimiter <SID>UppercaseKeyword('delimiter')
...
iabbrev <expr> <buffer> group_concat <SID>UppercaseKeyword('group_concat')
...
iabbrev <expr> <buffer> ifnull <SID>UppercaseKeyword('ifnull')
...
iabbrev <expr> <buffer> max_join_size <SID>UppercaseKeyword('max_join_size')
...
iabbrev <expr> <buffer> now <SID>UppercaseKeyword('now')
...
iabbrev <expr> <buffer> sql_big_selects <SID>UppercaseKeyword('sql_big_selects')
